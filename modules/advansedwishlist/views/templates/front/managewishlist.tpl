...
{if $products}
    ...
    <div class="wishlistLinkTop">
        ...
        <p class="wishlisturl form-group">
            ...
            <input type="text" class="form-control" value="{url entity='module' name='advansedwishlist' controller='view' params = ['token' => $token_wish]}" readonly="readonly"/>
        </p> 
        
        <p class="submit">
            <div id="showSendWishlist">
                <a class="btn btn-default button button-small" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='advansedwishlist'}">
