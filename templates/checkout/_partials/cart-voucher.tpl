    ...
    <div class="block-promo">
      <div class="cart-voucher">
        ...
        <a class="collapse-button promo-code-button" data-toggle="collapse" href="#promo-code" aria-expanded="false" aria-controls="promo-code">
          {l s='Vous bénéficiez d\'un code avantage ?' d='Shop.Theme.Checkout'}
        </a> 
        ...
        <div class="promo-code collapse{if $cart.discounts|count > 0} in{/if}" id="promo-code">
          {block name='cart_voucher_form'}
            <form action="{$urls.pages.cart}" data-link-action="add-voucher" method="post">
              ...
              <button type="submit" class="btn btn-voucher"><span>{l s='Appliquer à votre commande' d='Shop.Theme.Actions'}</span></button>
            </form>
          {/block}
        ...
        {if $cart.discounts|count > 0}
          <div class="block-promo promo-highlighted">
